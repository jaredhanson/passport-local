 ...
 * use `passport.authenticate()` middleware and specify the name of this
 * strategy and any options.
 *
 * @example
 ...
 *          object.
 * @param {Object} [options]
 * @param {string} options.badRequestMessage - Message to display when a request
 *          does not include a username or password.  Used in conjunction with
 *          `failureMessage` or `failureFlash` options.  **Default:** `'Missing
 *          credentials'`.
 */
